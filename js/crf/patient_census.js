function check_dates() {
    ...
    var date_onset = parseDate($('#date_onset').val());
    ...
    if(check_text('date_onset', 11) && !check_date('date_onset')) { invalid = true; }
    ...
    if (date_birth > date_onset) {
        change_status('date_birth', 2, DATES_INCONGRUENCE);
        change_status('date_onset', 2, DATES_INCONGRUENCE);
    } else if (date_onset > date_diagnosis) {
        change_status('date_onset', 2, DATES_INCONGRUENCE);
